---
name: django-tdd
description: Django 测试策略，使用 pytest-django、TDD 方法论、factory_boy、mocking、覆盖率，以及测试 Django REST Framework API。
origin: ECC
---
...
- **不要测试 Django 内部**：相信 Django 能工作
- **不要测试第三方代码**：相信库能工作
- **不要忽略失败的测试**：所有测试必须通过
- **不要让测试相互依赖**：测试应该以任何顺序运行
